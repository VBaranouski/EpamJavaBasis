...
public class LessonTwoPartTwo {
    ...
    public static void dayCountChecker() {
    ...
    public static void seasonChecker() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Введите номер месяца: ");
        Integer monthNumber = Integer.valueOf(sc.nextLine());
        seasonDefiner(monthNumber);

    }

    private static void seasonDefiner(Integer monthNumber) {
        switch (monthNumber) {
        case 12:
        case 1:
        case 2:
